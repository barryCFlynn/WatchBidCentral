...
class Listing(models.Model):
    ...
    manufacturer = models.CharField(
        max_length=100, choices=MANUFACTURER_CHOICES, default='None Selected')
    ...
    def save(self, *args, **kwargs):
        if not self.slug:  # Check if the slug needs to be generated
            ...
            # Trim slug size to fit max_length if necessary
    ...
    def __str__(self):
        return (f"The title of this listing is {self.title} "
...
class Comment(models.Model):
    ...
    parent_comment = models.ForeignKey(
        ...
        null=True,
        blank=True,
        # Helps in querying child comments of a parent
    ...
    def __str__(self):
        ...
        return (f"Comment by {self.author}: {self.body[:30]}"
                f"{'...' if len(self.body) > 30 else ''}")
